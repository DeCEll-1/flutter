...
class OdevGirisEkrani extends StatelessWidget {
  const OdevGirisEkrani({super.key});
...
class _GirisEkraniState extends State<GirisEkrani> {
  ...
  void HesapOlustur() {
    Navigator.pushNamed(context, "/YeniHesap",
        arguments:
            DataModel(kullaniciAdi: kullaniciTED.text, sifre: sifreTED.text));
  }
...
class YeniHesap extends StatefulWidget {
  const YeniHesap({super.key});

  @override
  State<YeniHesap> createState() => _YeniHesapState();
}
